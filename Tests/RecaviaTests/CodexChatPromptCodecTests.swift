...
@testable import Recavia
    ...
    struct CodexChatPromptCodecTests {
        ...
        func meetingContextRoundTripsWithEscapedCalendarMetadata() throws {
            ...
            #expect(prompt == """
            <context>
              You are viewing a meeting in the Recavia App.
              Type: Meeting
        ...
        func noncanonicalContextLikeMessagesRemainVisible() {
            ...
            <context>
              You are viewing an unsaved meeting draft in the Recavia App.
              Type: MeetingDraft
        ...
        func legacyAndMalformedMessagesRemainVisible() {
            ...
            let malformedBlocks = ["<context>not Recavia context</context>", "Keep this visible"]
