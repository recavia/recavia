...
public final class RecaviaMCPServer {
    ...
    public func handleLine(_ line: String) -> String? {
        ...
        do {
            ...
            return response(id: id, errorCode: -32000, message: "Unable to access Recavia meeting data")
        }
    }
    ...
    private var initializationResult: [String: Any] {
        [
            ...
            "serverInfo": ["name": "recavia", "version": "1.0.0"],
            "instructions": "Read-only access to one configured Recavia vault. "
    ...
    private func toolCallResponse(id: Any, name: String, arguments: [String: Any]) -> String {
        do {
            ...
            return response(id: id, result: toolError("Unable to read Recavia meeting data"))
        }
    }
