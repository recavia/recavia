...
public enum MeetingAccessError: Error, LocalizedError, Equatable {
    ...
    public var errorDescription: String? {
        ...
        case .databaseUpgradeRequired:
            "The Recavia database must be upgraded before meeting access can start. Open Recavia once, then try again."
        case .invalidSummaryDocument:
            "The stored summary document is invalid. Open Recavia and regenerate the summary."
        case .invalidCursor:
