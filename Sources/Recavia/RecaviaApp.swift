...
struct RecaviaApp: App {
    ...
    var body: some Scene {
        Window(L10n.recavia, id: WindowID.main) {
            Group {
                if showVaultPicker {
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationWillFinishLaunching(_: Notification) {
        do {
            ...
            alert.messageText = L10n.anotherRecaviaInstanceTitle
            alert.informativeText = L10n.anotherRecaviaInstanceMessage
            alert.runModal()
