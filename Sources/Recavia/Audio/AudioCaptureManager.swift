...
final class AudioCaptureManager: NSObject, @unchecked Sendable {
    private static let logger = Logger(subsystem: "com.recavia", category: "MicrophoneCapture")
    ...
    private let lifecycleQueue = DispatchQueue(label: "com.recavia.microphone-capture.lifecycle")
