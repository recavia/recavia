...
enum L10n {
    ...
    static var recavia: String { String(localized: "Recavia", bundle: bundle) }
    static var anotherRecaviaInstanceTitle: String { String(localized: "Recavia Is Already Running", bundle: bundle) }
    static var anotherRecaviaInstanceMessage: String { String(
        localized: "Another Recavia process is already using the recording database. This process will now quit.",
        bundle: bundle
    ) }
    ...
    static var recordingAudioAmbiguous: String { String(
        localized: "Multiple recording files exist and Recavia cannot safely choose one.",
        bundle: bundle
    ) }
    ...
    static var recordingAudioInvalidPath: String { String(
        localized: "Recavia refused an unsafe recording file path.",
        bundle: bundle
    ) }
    ...
    static func projectRollbackFailed(operation: String, rollback: String) -> String {
        String(
            localized: "The project operation failed (\(operation)), and Recavia could not restore the folder (\(rollback)).",
            bundle: bundle
        )
    }
    ...
    static var screenshotIntervalDescription: String { String(
        localized: "Choose how often Recavia checks the screen for meaningful changes.",
        bundle: bundle
    ) }
    ...
    static var retainBatchAudioDescription: String { String(
        localized: "Keep the protected audio in Recavia after batch transcription succeeds.",
        bundle: bundle
    ) }
    ...
    static var googleDriveExportDestinationDescription: String { String(
        localized: "On first connection, Recavia creates Meeting Notes directly under My Drive and exports Google Docs into it. The export destination is fixed to this folder.",
        bundle: bundle
    ) }
    ...
    static var macOSCalendarAccessDeniedMessage: String { String(
        localized: "Allow Recavia to access Calendars in System Settings > Privacy & Security > Calendars.",
        bundle: bundle
    ) }
    ...
    static var googleCalendarClientSecretMissingMessage: String { String(
        localized: "This Google OAuth client requires a client secret. Enter the value from Google Cloud Console in Developer Settings and relaunch Recavia.",
        bundle: bundle
    ) }
    ...
    static var removeVaultConfirmationDescription: String { String(
        localized: """
        Recavia will remove this vault and its meeting history from the app. \
    ...
    static var codexHelperNotBundled: String { String(
        localized: "The bundled Codex helper is unavailable. Run Recavia with scripts/run-dev.sh or install a signed app build.",
        bundle: bundle
    ) }
    ...
    static var codexOutputBufferOverflow: String { String(
        localized: "Codex produced output faster than Recavia could process it.",
        bundle: bundle
    ) }
    ...
    static var codexAccountDescription: String { String(
        localized: "Recavia stores a separate Codex sign-in for this app. Signing in opens your browser.",
        bundle: bundle
    ) }
    ...
    static var databricksCLINotInstalled: String { String(
        localized: "Databricks CLI was not found. Install it and relaunch Recavia.",
        bundle: bundle
    ) }
    ...
    static var databricksCodexDescription: String { String(
        localized: "Recavia writes the selected profile to its Codex configuration. Tokens remain managed by Databricks CLI.",
        bundle: bundle
    ) }
    ...
    static var applicationLogsDescription: String { String(
        localized: "View Recavia logs from the current app session. Private values remain redacted.",
        bundle: bundle
    ) }
    ...
    static var noApplicationLogsDescription: String { String(
        localized: "Use Recavia, then refresh to load new log entries.",
        bundle: bundle
    ) }
    ...
    static var systemMicrophoneModeDescription: String { String(
        localized: """
        Recavia uses the microphone mode selected in the macOS menu bar when the active audio route \
    ...
    static var menuBarOpenRecavia: String { String(localized: "Open Recavia", bundle: bundle) }
    ...
    static var menuBarQuitRecavia: String { String(localized: "Quit Recavia", bundle: bundle) }
    ...
    static func menuBarOpenEventInRecavia(_ title: String) -> String {
        String(localized: "Open \(title) in Recavia", bundle: bundle)
    }
    ...
    static var notificationConditionsDescription: String { String(
        localized: "Choose when Recavia sends a meeting notification.",
        bundle: bundle
    ) }
