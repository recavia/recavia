...
enum CodexChatPromptCodec {
    ...
    private static let meetingDescription = "  You are viewing a meeting in the Recavia App.\n"
    private static let meetingDraftDescription = "  You are viewing an unsaved meeting draft in the Recavia App.\n"
    ...
    private static func encodeContext(_ context: CodexChatContext) -> String {
        ...
        case let .meeting(id, name, calendarEvent):
            lines.append("  You are viewing a meeting in the Recavia App.")
        ...
        case let .meetingDraft(_, name, calendarEvent):
            lines.append("  You are viewing an unsaved meeting draft in the Recavia App.")
