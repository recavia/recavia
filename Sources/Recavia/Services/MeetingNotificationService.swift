...
private let meetingNotificationPayloadKey = "recaviaDetectedMeeting"
...
final class MeetingNotificationService: NSObject, UNUserNotificationCenterDelegate {
    ...
    private static let microphoneCategoryIdentifier = "recavia.meeting.microphone"
    private static let calendarCategoryIdentifier = "recavia.meeting.calendar"
    private static let calendarJoinCategoryIdentifier = "recavia.meeting.calendar.join"
    private static let startRecordingActionIdentifier = "recavia.meeting.start-recording"
    private static let joinAndStartRecordingActionIdentifier = "recavia.meeting.join-and-start-recording"
    private static let calendarRequestPrefix = "recavia.meeting.calendar.request."
    private static let microphoneRequestPrefix = "recavia.meeting.microphone.request."
    private static let threadIdentifier = "recavia.meeting"
