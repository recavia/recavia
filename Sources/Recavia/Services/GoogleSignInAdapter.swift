...
private final class LoopbackRedirectServer: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.recavia.google-oauth-loopback")
    ...
    private func handle(connection: NWConnection) {
        ...
        connection.receive(minimumIncompleteLength: 1, maximumLength: 16384) { [weak self] data, _, _, error in
            ...
            reply(to: connection, status: "200 OK", body: "Recavia authorization completed. You can close this window.")
