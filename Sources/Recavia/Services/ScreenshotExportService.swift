...
/// スクリーンショットを Vault の `_recavia/screenshots/` フォルダに書き出すサービス。
enum ScreenshotExportService {
    ...
    /// スクリーンショットを `<vault>/_recavia/screenshots/<screenshotId>.<ext>` に書き出す。
    ...
    static func exportScreenshots(
        ...
        for screenshot in screenshots {
            ...
            let relativePath = "_recavia/screenshots/\(filename)"
